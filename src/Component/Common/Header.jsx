...
function Header() {
    ...
    return (
        <>
        {/* <header className={`relative pb-6 max-md:px-2 bg-white lg:pb-0 ${scroll ? 'sticky' : ''} ${scroll ? 'shadow-md' : ''}`}>
            <div className="px-4 mx-auto sm:px-6 lg:px-8 pb-4 max-w-[82rem]">
                <nav className="flex items-center justify-between h-16 lg:h-20">
                    <div className="flex-shrink-0">
                        <Link to="/" className="flex">
        ...
        <header className='flex justify-between py-4 bg-black text-white'>
            <p>fg</p>
            <p>fsdfreg</p>
        </header>
        </>
