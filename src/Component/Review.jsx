...
const ReviewItem = ({ count, label }) => (
  <div className="text-center text-[#BEF200]">
    <h2 className="text-6xl max-lg:text-5xl font-bold">{count}</h2>
    <p className=" text-base font-semibold">{label}</p>
  </div>
);

const Review = () => (
  <div className="grid lg:grid-cols-4 mt-20 max-lg:grid-cols-2 max-md:grid-cols-2 bg-[#012112] px-8 py-12 gap-10 max-md:gap-4 ">
