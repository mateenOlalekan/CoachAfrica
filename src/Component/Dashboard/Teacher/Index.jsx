  ...
  return (
    <div className="py-2 px-2 mt-2 w-full  pb-3 overflow-y-auto overflow-hidden">
      <ScheduleHeader />
        ...
        <div className="flex flex-row h-auto w-11/12 overflow-x-hidden">
<div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
    ...
    <div className="flex flex-col mt-8">
        ...
        <div className="flex flex-col space-y-1 mt-4 -mx-2 overflow-y-auto" style={{ maxHeight: "calc(100vh - 248px)"
            }}>
